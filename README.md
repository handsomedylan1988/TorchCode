...
| # | Problem | What You'll Implement | Difficulty | Freq | Key Concepts |
|:---:|---------|----------------------|:----------:|:----:|--------------|
| 42 | <a href="https://github.com/duoan/TorchCode/blob/master/templates/42_stable_diffusion.ipynb" target="_blank">Stable Diffusion Foundations — Toy DDPM</a> <a href="https://colab.research.google.com/github/duoan/TorchCode/blob/master/templates/42_stable_diffusion.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `diffusion_loss`, `sample_ddpm` | ![Hard](https://img.shields.io/badge/Hard-F44336?style=flat-square) | 💡 | Noise prediction, forward diffusion, reverse DDPM sampling |
| 43 | <a href="https://github.com/duoan/TorchCode/blob/master/templates/43_flow_matching.ipynb" target="_blank">Conditional Flow Matching</a> <a href="https://colab.research.google.com/github/duoan/TorchCode/blob/master/templates/43_flow_matching.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `compute_fm_loss`, `sample_ode` | ![Hard](https://img.shields.io/badge/Hard-F44336?style=flat-square) | 💡 | 2D generation, conditional vector fields, Euler ODE sampling |
